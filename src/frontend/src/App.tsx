...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f1f3f6] font-sans">
        ...
        <div className="flex gap-0 max-w-7xl mx-auto">
          {SALE_DEALS.map((deal) => (
            ...
            >
              ...
              <span className="block text-xs font-bold">{deal.title}</span>
          ...
          <div className="flex items-center justify-between px-4 pt-4 pb-3 border-b border-gray-100">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1 ml-2">
                <span className="text-xs text-gray-500 mr-1">Ending in</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-white font-bold text-lg">SnapKart</span>
              </div>
              <p className="text-xs leading-relaxed">
                India's fastest growing e-commerce platform with the best deals
                    ...
                    <span className="font-semibold">
                      {formatPrice(
                        cart.reduce(
                          (s, i) =>
                            s +
                            (i.product.originalPrice - i.product.salePrice) *
                              i.quantity,
                          0,
                        ),
                      )}
      ...
      {/* ── Wishlist Drawer ──────────────────────────────────────────────────── */}
      {wishlistOpen && (
        <div className="fixed inset-0 z-50 flex" data-ocid="wishlist.modal">
          <div
            role="button"
            tabIndex={0}
            ...
            onKeyDown={(e) => e.key === "Escape" && setWishlistOpen(false)}
          />
          <div className="w-full max-w-sm bg-white h-full flex flex-col shadow-2xl">
            <div className="flex items-center justify-between p-4 border-b">
              <h2 className="font-bold text-lg text-gray-900">
